...
namespace App\Models;
    ...
    final class Reserva
    {
        ...
        public function set_data(string $data): Reserva{
            $this->data = $data;
            return $this;
        }
        ...
        public function set_hora(string $hora): Reserva{
            $this->hora = $hora;
            return $this;
        }
        ...
        public function set_quantidade_pessoas(int $quantidade_pessoas): Reserva{
        ...
        public function set_data_marcada(string $data_marcada): Reserva{
        ...
        public function set_hora_marcada(string $hora_marcada): Reserva{
