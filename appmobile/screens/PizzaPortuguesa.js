...
class PizzaPortuguesa extends React.Component{
    constructor(){
      ...
      componentDidMount(){ 
        console.log("Montando o ecrã Pizza Portuguesa...");
      }
      render(){
       /* const data = [
          {
        ...
        return (
          <View style={style.container}>
            ...
            <ScrollView>
                ...
                <Image source={require('../assets/portuguesa.jpg')} style={style.image} opacity={0.8}/>
                <Text style={style.text}> A pizza mais deliciosa do restaurante Sabor da Avó.</Text>
...
export default PizzaPortuguesa;