...
class Login extends React.Component {
    ...
    _login = async() => {
        ...
        if(validEmail==true && validPass==true){
            try
            {
                let response = await fetch('http://194.210.89.189/Ementas-de-Restauracao/index.php/Login', { 
                    method: 'POST',
                    headers: {
                ...
                try {
                    let response = await fetch('http://194.210.89.189/Ementas-de-Restauracao/index.php/Utilizador', { 
                      headers: {
