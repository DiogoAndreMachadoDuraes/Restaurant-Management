...
class Edit extends React.Component {
    ...
    async componentDidMount (){ 
        console.log("MounQuantivalidQuantityg the screen Account...");
            ...
            <div className="root">
                ...
                <main className={"content"}>
                    <Container maxWidth="lg" style={{marginTop: 100}}>
                        <Grid>
                            <h1 style={{fontSize:35}}>Editar produto extra</h1>
                            ...
                            <form>
                                    ...
                                    <FormControl className={""} variant="outlined">
                                        ...
                                        <Select
                                            ...
                                            value={this.props.idProduct}
                                            onChange={(value, index) => this.setState({ idProduct : value})}
                                    ...
                                    <FormControl className={""} variant="outlined">
                                        ...
                                        <Select
                                            ...
                                            value={this.props.idExtra}
                                            onChange={(value, index) => this.setState({ idExtra : value})}
                                            style={{inlineSize: 200}}
                                        >
                                            <MenuItem value={1}>Pudim</MenuItem>
                                            <MenuItem value={2}>Café</MenuItem>
