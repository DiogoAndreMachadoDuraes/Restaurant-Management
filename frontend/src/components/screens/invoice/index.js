...
class Invoice extends React.Component {
    ...
    async componentDidMount (){ 
        ...
        try {
            let response = await fetch('http://192.168.1.117/Ementas-de-Restauracao/index.php/Fatura', { 
                headers: {
                    ...
                    <Container maxWidth="lg" className={"container"} style={{marginTop: 100}}>
                        <Grid container spacing={3}>
                            ...
                            <Paper elevation={3} className={"paper"}>
                                <label htmlFor="email">Fatura</label>
                                <Table size="small">
                                    <TableHead>
                                    <TableRow>
                                        ...
                                        <TableCell>Nif Cliente</TableCell>
