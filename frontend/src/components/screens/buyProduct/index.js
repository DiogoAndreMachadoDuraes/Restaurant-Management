...
class BuyProduct extends React.Component {
    ...
    goCreate() {
        this.props.history.push("/buyProductCreate");
    }

    goEdit() {
        this.props.history.push("/buyProductEdit");
    }
                    ...
                    <Container maxWidth="lg" className={"container"} style={{marginTop: 100}}>
                        <Grid container spacing={3}>
                            ...
                            <Paper elevation={3} className={"paper"}>
                                <label htmlFor="email">Compra de produtos:</label>
                                <Table size="small">
                                    <TableHead>
                                    <TableRow>
                                        ...
                                        <TableCell>
                                            <ListItem button style={{whidth: 10}}>
                                                ...
                                                <ListItemText primary="Nova" onClick={this.goEdit} />
                                            </ListItem>
                                        </TableCell>
                                    </TableRow>
                                    </TableHead>
                                    <TableBody>
                                    {
                                        data.map((item) => {
                                            ...
                                            <TableRow key={item.id_produto}>
                                                ...
                                                <TableCell align="right">{item.id_reserva}</TableCell>
                                            </TableRow>
                                            );
                                        })
                                    }
