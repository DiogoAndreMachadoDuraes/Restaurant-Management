...
class Employee extends React.Component {
    ...
    async componentDidMount (){ 
        console.log("Mounting the screen Employee...");
    ...
    goCreate() {
        this.props.history.push("/employeeCreate");
    }

    goEdit() {
        this.props.history.push("/employeeEdit");
    }
                    ...
                    <Container maxWidth="lg" className={"container"} style={{marginTop: 100}}>
                        <Grid container spacing={3}>
                            ...
                            <Paper elevation={3} className={"paper"}>
                                <label htmlFor="email">Funcionário</label>
                                <Table size="small">
                                    <TableHead>
                                    <TableRow>
                                        <TableCell>Id Restaurante</TableCell>
