...
class Create extends React.Component {
    ...
    async componentDidMount (){ 
        console.log("Mounting the screen Create Nutritional Information...");
    ...
    save = async () => {
        //guardar dados
        this.props.history.push("/nutritionalInformation");
    }
            ...
            <div className="root">
                ...
                <main className={"content"}>
                    <Container maxWidth="lg" style={{marginTop: 100}}>
                        <Grid>
                            <h1 style={{fontSize:35}}>Criar Informação Nutricional</h1>
