...
class NutritionalInformation extends React.Component {
    ...
    goCreate() {
        this.props.history.push("/nutritionalInformationCreate");
    }

    goEdit() {
        this.props.history.push("/nutritionalInformationEdit");
    }
                    ...
                    <Container maxWidth="lg" className={"container"} style={{marginTop: 100}}>
                        <Grid container spacing={3}>
                            ...
                            <Paper elevation={3} className={"paper"}>
                                <label htmlFor="email">Informação Nutricional</label>
                                <Table size="small">
                                    <TableHead>
                                    <TableRow>
                                        <TableCell>Tipo</TableCell>
                                        <TableCell>Quantidade de nutrientes</TableCell>
                                        <TableCell>Id Produto</TableCell>
                                        <TableCell>Id Extra</TableCell>
                                        <TableCell></TableCell>
                                        <TableCell>
                                    ...
                                    <TableBody>
                                    {
                                        data.map((item) => {
                                            return(
                                            <TableRow key={item.id_info_nutricional}>
                                                <TableCell>{item.tipo}</TableCell>
                                                <TableCell>{item.quantidade_nutrientes}</TableCell>
                                                <TableCell>{item.id_produto}</TableCell>
                                                <TableCell>{item.id_extra}</TableCell>
                                            </TableRow>
                                            );
                                        })
                                    }
